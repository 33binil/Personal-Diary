                                ...
                                <div className="mt-2 max-h-64 overflow-auto">
                                    {entriesByDate.length === 0 ? (
                                        ...
                                        entriesByDate.map(ed => (
                                            <button key={ed.date} onClick={() => { setShowCalendarOverlay(false); navigate(`/user3?date=${ed.date}`) }} className="w-full text-left p-2 mb-2 rounded bg-white/5 hover:bg-white/10">
