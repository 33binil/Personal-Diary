...
const Profile1 = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 flex flex-col text-white p-4 sm:p-6 overflow-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8 mb-8 sm:mb-12 px-4">
                ...
                <div className="relative">
                    <div className="w-24 h-24 sm:w-32 sm:h-32 lg:w-40 lg:h-40 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center overflow-hidden shadow-2xl ring-4 ring-white/20">
                        {user?.photoURL ? (
                            <img
                                src={user.photoURL}
                                alt="Profile"
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-3 justify-center sm:justify-start">
                                <input
                                    ...
                                    className="bg-white/10 backdrop-blur-sm text-white text-xl sm:text-2xl lg:text-3xl font-semibold px-4 py-2 rounded-xl border border-white/30 focus:border-white focus:outline-none focus:ring-2 focus:ring-blue-400"
                                    disabled={isUpdating}
            ...
            <div className="flex items-center justify-center px-4 sm:px-6 mb-8 sm:mb-12">
                <div className="w-full max-w-4xl h-48 sm:h-64 lg:h-80 rounded-2xl overflow-hidden relative bg-gradient-to-br from-blue-600/20 to-purple-600/20 backdrop-blur-sm border border-white/10">
                    {/* Background Pattern */}
