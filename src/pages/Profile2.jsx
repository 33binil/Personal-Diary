...
const Profile2 = () => {
    ...
    return (
        <div className="w-screen h-screen bg-[#D66D81] flex flex-col text-white p-4 sm:p-6 overflow-auto">
            ...
            <div className="flex items-center gap-4 sm:gap-6 mb-4 px-4 sm:px-6 lg:pl-44">
                <div className="w-16 h-16 md:w-24 md:h-24 lg:w-[130px] lg:h-[130px] rounded-full bg-[#C8354C] flex items-center justify-center overflow-hidden">
                    {user?.photoURL ? (
                        <img 
                            src={user.photoURL} 
                            alt="Profile" 
                    ...
                    {isEditingName ? (
                        <div className="flex items-center gap-2">
                            <input 
                                ...
                                className="bg-[#C8354C] text-white text-xl md:text-2xl lg:text-3xl font-piedra tracking-wider px-3 py-1 rounded border border-white/30 focus:border-white focus:outline-none"
                                disabled={isUpdating}
            ...
            <div className="flex items-center justify-center px-4 sm:px-6 mb-10">
                <div className="w-full max-w-[1546px] h-40 sm:h-56 md:h-64 lg:h-[314px] mb-12 md:mb-16 lg:mb-24 rounded-lg overflow-hidden relative">
                    <img src="/theme2.png" alt="Large mobile" className="block sm:hidden w-full h-full object-cover" />
                    <img src="/theme2.png" alt="Large desktop" className="hidden sm:block w-full h-full object-cover" />
