...
const Profile2 = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-900 via-pink-900 to-rose-900 flex flex-col text-white p-4 sm:p-6 overflow-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8 mb-8 sm:mb-12 px-4">
                ...
                <div className="relative">
                    <div className="w-24 h-24 sm:w-32 sm:h-32 lg:w-40 lg:h-40 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center overflow-hidden shadow-2xl ring-4 ring-white/20">
                        {user?.photoURL ? (
                            <img
                                src={user.photoURL}
                                alt="Profile"
                    ...
                    <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-green-500 rounded-full border-4 border-purple-900 flex items-center justify-center">
                ...
                <div className="flex-1 text-center sm:text-left">
                    {isEditingName ? (
                        <div className="space-y-3">
                            <div className="flex items-center gap-3 justify-center sm:justify-start">
                                <input
                                    ...
                                    className="bg-white/10 backdrop-blur-sm text-white text-xl sm:text-2xl lg:text-3xl font-semibold px-4 py-2 rounded-xl border border-white/30 focus:border-white focus:outline-none focus:ring-2 focus:ring-purple-400"
                                    disabled={isUpdating}
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center gap-3 justify-center sm:justify-start">
                                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-white to-pink-200 bg-clip-text text-transparent">
            ...
            <div className="flex items-center justify-center px-4 sm:px-6 mb-8 sm:mb-12">
                <div className="w-full max-w-4xl h-48 sm:h-64 lg:h-80 rounded-2xl overflow-hidden relative bg-gradient-to-br from-purple-600/20 to-pink-600/20 backdrop-blur-sm border border-white/10">
                    {/* Background Pattern */}
