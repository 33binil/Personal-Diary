...
const Option3 = ({ open = false, onClose = () => {} }) => {
    ...
    const handleDateSelect = () => {
        if (selectedDate) {
            navigate(`/user3?date=${selectedDate}`);
            ...
            >
                ...
                <div className="px-6 py-4 border-b border-white/10">
                    <div className="flex items-center gap-4">
                        <div className="w-16 h-16 rounded-full bg-[#1B2424]/30 flex items-center justify-center">
                ...
                <div className="p-4 space-y-2">
                    <button
                        ...
                        className="w-full flex items-center gap-3 p-3 rounded-lg hover:bg-[#1B2424]/30 transition-colors text-white/90 hover:text-white"
                    >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-white/10">
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 p-3 rounded-lg bg-[#1B2424]/30 hover:bg-[#1B2424]/40 text-white transition-colors"
                    >
                    ...
                    <div className="relative bg-[#1A1A2E]/90 backdrop-blur-xl rounded-2xl p-6 w-full max-w-md border border-white/10 shadow-2xl">
                        ...
                        <div className="space-y-4">
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 text-white focus:outline-none focus:ring-2 focus:ring-[#1B2424] transition-all"
                            />
                            <button
                                ...
                                className={`w-full py-3 px-4 rounded-lg font-medium transition-colors ${
                                    selectedDate 
                                        ? 'bg-[#1B2424] text-white hover:bg-[#2a3737]' 
