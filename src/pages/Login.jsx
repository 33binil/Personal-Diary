...
const Login = () => {
    ...
    const [understandRequirement, setUnderstandRequirement] = useState(false);
    ...
    const handleSignInClick = () => {
        // For existing users, skip the welcome popup and go directly to account selection
        handleGoogleAccountPicker();
    };
            ...
            <div className="relative max-w-md w-full space-y-12">
                ...
                {showWelcomePopup && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center">
                        <div className="relative bg-white rounded-2xl shadow-2xl p-6 sm:p-8 max-w-md w-full mx-auto max-h-[90vh] overflow-y-auto">
                            {/* Close Button */}
                            <button
                            ...
                            <div className="text-center pt-2">
                                ...
                                <div className="mb-6">
                                    <img
                                        src="/check.webp"
                                        alt="Google Drive Permissions"
                                        className="w-32 h-32 mx-auto rounded-lg shadow-lg cursor-pointer hover:opacity-80 transition-opacity"
                                ...
                                <p className="text-sm sm:text-base text-gray-600 mb-6 leading-relaxed">
                                    You need to allow access to Google Drive to securely store your diary entries.
                                    If this permission is not granted, your diary entries cannot be saved to Google Drive.
                                </p>
                                ...
                                <div className="mb-6 text-left">
                                    <label className="flex items-start space-x-3 cursor-pointer">
                                        <input
                                            type="checkbox"
                                            checked={understandRequirement}
                                            onChange={(e) => setUnderstandRequirement(e.target.checked)}
                                            className="mt-1 h-4 w-4 text-red-600 focus:ring-red-500 border-gray-300 rounded"
                                        />
                                        <span className="text-sm text-gray-700 leading-relaxed">
                                            I understand - If I don't tick the box in Google Drive, my diary won't save
                                        </span>
                                    </label>
                                </div>
                                ...
                                <div className="space-y-3">
                                    <button
                                        onClick={handleGoogleAccountPicker}
                                        disabled={!understandRequirement}
                                        className={`w-full flex items-center justify-center px-6 py-3 rounded-xl transition-all duration-200 transform shadow-lg ${
                ...
                {showExpandedImage && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 sm:px-6 lg:px-8">
                        <div className="absolute inset-0 bg-black bg-opacity-90 backdrop-blur-sm" onClick={() => setShowExpandedImage(false)}></div>
                        <div className="relative max-w-4xl max-h-[90vh] mx-auto">
                            ...
                            <img
                                src="/check.webp"
                                alt="Google Drive Permissions - Expanded View"
