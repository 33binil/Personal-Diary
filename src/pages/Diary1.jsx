    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                console.warn('Failed to load entry for decodedId', err)
            } finally {
                setIsLoadingEntry(false)
            }
        })()
        ...
        <div className="min-h-screen w-full bg-[#001331] text-white relative pb-28">
            ...
            <div className="flex items-center justify-between px-4 sm:px-6 md:px-8 pt-4 sm:pt-6 md:pt-8">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <button onClick={() => { setShowDonePopup(true); handleSave(); setTimeout(() => navigate('/user1', { state: { timestamp: Date.now(), key: Math.random() } }), 1200); }} className="px-6 py-2 rounded-xl bg-white/80 text-[#001331] font-semibold shadow-sm hover:bg-white">
                        Save
                    </button>
                </div>
            </div>
