...
const Diary1 = () => {
    ...
    const [audioClips, setAudioClips] = useState([]) // { name, dataUrl, durationMs }
    ...
    useEffect(() => {
        ...
        // Otherwise attempt to load from Drive entries (requires driveInitialized)
        (async () => {
            try {
                ...
                console.warn('Failed to load entry for openId', err)
            } finally {
                setIsLoadingEntry(false)
            }
        })()
        ...
        try {
            ...
            mediaRecorder.onstop = async () => {
                try {
                    ...
                    setAudioClips(prev => [...prev, { name: `recording_${new Date().toISOString()}.webm`, dataUrl, durationMs }])
                } catch (err) {
    ...
    const handleSave = async () => {
        ...
        try {
...

            {
                ...
                // Navigate after short delay so popup is visible
                setTimeout(() => {
    ...
    return (
        <div className="min-h-screen w-full bg-[#001331] text-white relative pb-28">
            ...
            <div className="flex items-center justify-between px-4 sm:px-6 md:px-8 pt-4 sm:pt-6 md:pt-8">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <button onClick={() => { setShowDonePopup(true); handleSave(); setTimeout(() => navigate('/user1'), 1200); }} className="px-6 py-2 rounded-xl bg-white/80 text-[#001331] font-semibold shadow-sm hover:bg-white">
                        Save
                    </button>
                </div>
            </div>
            ...
            <div className="px-6 md:px-24 mt-6 md:mt-8">
                ...
                <input
                    ...
                    className="w-full bg-transparent text-white placeholder-gray-400 text-lg md:text-xl font-semibold border-b border-white/20 focus:border-white/60 outline-none pb-2 mb-4"
                />
            </div>
            ...
            {/* Media preview bar (below prompt) */}
            ...
            <div className="fixed left-1/2 -translate-x-1/2 bottom-4 sm:bottom-5 md:bottom-6">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl px-6 sm:px-8 md:px-10 py-2 sm:py-3 flex items-center gap-8 md:gap-16 shadow-lg">
            ...
            {showLeavePrompt && (
                <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/60">
                    <div className="bg-[#0b1a38] text-white rounded-2xl p-6 w-[90%] max-w-sm border border-white/20">
